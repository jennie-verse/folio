...
/** Sort, Filter by type, and My highlights and notes are folded into one
    "..." menu sheet instead of separate icon buttons, since on a narrow
    phone that would be 4 icon buttons plus the search input fighting for
    space. Select stays a standalone button since it's a persistent mode
    toggle, not a one-off action. */
